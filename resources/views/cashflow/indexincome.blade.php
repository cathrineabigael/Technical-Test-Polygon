                                        ...
                                        <tr id="tr_{{ $s->id }}">
                                            ...
                                            <td>
                                                ...
                                                <button class="btn btn-danger btn-xs" type="button"
                                                    ...
                                                    onclick="deleteincome({{ $s->id }})">Delete</button>
...
@section('script')
    <script>
        function verif(id) {
            swal({
                    title: "Yakin verifikasi pemasukan?",
                        ...
                        $.post('{{ route('income.verif') }}', {
                            ...
                            function(data) {
                                if (data.status == "sukses") {
                                    ...
                                    swal("Pemasukan berhasil diverifikasi", {
                                        icon: "success",
                                    });

                                } else {
                                    swal("Pemasukan gagal diverifikasi", {
                                        title: "Pemasukan gagal diverifikasi",
                                        icon: "error",
                                    });
                                }
                                // alert(data.msg);
                        ...
                        $.post('{{ route('income.delete_data') }}', {
                            ...
                            function(data) {
                                if (data.status == "sukses") {
                                    ...
                                    swal("Pemasukan berhasil dihapus", {
                                        icon: "success",
                                    });
                                    // location.reload();

                                } else {
                                    swal("Pemasukan gagal dihapus", {
                                        title: "Pemasukan gagal dihapus",
